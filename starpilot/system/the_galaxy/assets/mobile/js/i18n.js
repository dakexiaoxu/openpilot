...
const MORE_TRANSLATIONS = {
  ...
  "zh-CHS": {
    ...
    "Sentry, PiP side camera, & V-ASM spot monitor": "哨兵、画中画侧视摄像头和 V-ASM 点位监控",
    "Remote access, pairing, & app install": "远程访问、配对和应用安装",
    "Error logs, tmux, troubleshoot": "错误日志、tmux 和故障排查",
    "Install/swap models": "安装或更换模型",
    "Pair lateral and longitudinal models": "配对横向和纵向模型",
    "Offline maps & destinations": "离线地图和目的地",
    "Backup, restore, updates": "备份、恢复和更新",
    "Customize the look": "自定义外观",
    "Steering & speed tuning, live plots, testing grounds": "转向和车速调校、实时图表和测试区",
    "Vehicle features": "车辆功能",
    "Galaxy & App Install": "Galaxy 和应用安装",
    Controllers: "手柄",
    "Bluetooth Devices": "蓝牙设备",
    "Sentry Mode": "哨兵模式",
    "V-ASM Spot Monitor": "V-ASM 点位监控",
    "PiP Side Camera": "画中画侧视摄像头",
    Destination: "目的地",
    Maps: "地图",
    "App Keys": "应用密钥",
    "Speed Limits": "限速",
    "View sections": "查看分区",
    "This setting can only be changed while the vehicle is in Park.": "此设置只能在车辆处于驻车挡时更改。",
    "Disabled by another setting.": "已被另一项设置停用。",
    "Required configuration missing.": "缺少必需配置。",
    "Learn Button": "学习按键",
    "Listening...": "正在监听...",
    "Listening ({n}s)": "正在监听（{n}秒）",
    Favorite: "收藏",
    "Controller Action": "手柄动作",
    Button: "按键",
    "is mapped to slot": "已映射到槽位",
    "has no mapping": "没有映射",
    "Test Buttons": "测试按键",
    "Stop Testing": "停止测试",
    "Clear All": "全部清除",
    "Disconnect controllers when offroad": "非行驶时断开手柄",
    "After two minutes offroad, paired controllers disconnect to save battery and reconnect when the car starts. Bluetooth and audio-only devices stay connected.": "非行驶两分钟后，已配对手柄会断开以省电，车辆启动后再连接。蓝牙和纯音频设备保持连接。",
    "Mappings can only be changed while offroad. Mapped buttons continue working onroad.": "只能在非行驶时更改映射。已映射按键在行驶中仍可使用。",
    "The wheel control service is starting.": "方向盘控制服务正在启动。",
    "Connected input devices": "已连接的输入设备",
    "Favorite buttons are the default, with controller-only actions below. Only the selected gamepad controls Joystick Mode.": "收藏按键为默认项，下方是仅手柄动作。只有选中的手柄可以控制摇杆模式。",
    "Buttons and joystick axes": "按键和摇杆轴",
    "Buttons only": "仅按键",
    "Enabled for Joystick Mode": "已用于摇杆模式",
    "Enable for Joystick Mode": "用于摇杆模式",
    "Connect or pair a controller, macropad, or keyboard.": "请连接或配对手柄、宏键盘或键盘。",
    "On-screen Favorites": "屏幕收藏键",
    "Not configured": "未配置",
    "Choose and enable these slots in Toggles to map buttons to them.": "请在开关页选择并启用这些槽位，再映射按键。",
    "Controller-only Actions": "仅手柄动作",
    "Ten additional actions for physical buttons. These never appear as on-screen Favorites.": "另外十个实体按键动作。它们不会出现在屏幕收藏键中。",
    Configured: "已配置",
    "Choose action": "选择动作",
    "Set speed": "设定车速",
    "Press one button on your controller, macropad, or keyboard.": "请在手柄、宏键盘或键盘上按下一个键。",
    Successful: "成功",
    "Not mapped": "未映射",
    "External input": "外部输入",
