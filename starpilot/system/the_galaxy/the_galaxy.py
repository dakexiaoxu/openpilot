...
from openpilot.starpilot.common.settings_zh_chs import ZH_CHS, attach_section_slugs, language_wants_chinese, reload_map, translate_catalog
...
def setup(app):
  ...
  def device_settings_layout_asset():
    ...
    try:
      reload_map()
      attach_section_slugs(layout_data)
